...
// Check is value is NaN (Not a Number)
...
console.log(324897349835612382348n);
console.log(BigInt(3248973));

// Operations
console.log(10000n + 10000n);
console.log(39485798723423432443857324987532533532n * 100000000n);
// console.log(Math.sqrt(16n));

const huge = 329785623894732985634983n;
const num = 23;
...
console.log(new Date("Oct 25 2021 08:55:10"));
